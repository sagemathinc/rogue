...
char *inv_t_name[] = {"Overwrite", "Slow", "Clear"};
...
int e_levels[] = {10L,      20L,      40L,     80L,     160L,    320L,
                  640L,     1300L,    2600L,   5200L,   13000L,  26000L,
                  50000L,   100000L,  200000L, 400000L, 800000L, 2000000L,
                  4000000L, 8000000L, 0L};
...
struct obj_info weap_info_5_3[MAXWEAPONS + 1] = {
    ...
    {NULL, 0, 0, NULL,
     FALSE}, /* DO NOT REMOVE: fake entry for dragon's breath */
};
